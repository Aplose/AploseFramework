...
import fr.aplose.aploseframework.constantes.dolibarr.DolibarrEntityTypes;
import fr.aplose.aploseframework.constantes.dolibarr.DolibarrStatus;
import fr.aplose.aploseframework.constantes.dolibarr.DolibarrThirdPartyClientTypes;
...
public class ThirdParty extends DolibarrObject{
    ...
    private Map<String, Object> array_options = new HashMap<>();
    ...
    public Map<String, Object> getArray_options() {
    ...
    public String getStripeCustomerId(){
        return (String) this.array_options.get("options_stripe_customer_id");
    }
    ...
    public String getStripeAccountId(){
        return (String) this.array_options.get("options_stripe_account_id");
    }
